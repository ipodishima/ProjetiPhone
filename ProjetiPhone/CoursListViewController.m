...
- (void)viewDidLoad
{
    ...
    _listOfLessons = [[NSArray alloc] initWithObjects:@"Cours 1", @"cours 2",@"cours 3", @"cours 4",@"cours 5",@"cours 6",@"cours 7",@"cours 8",@"cours 9", nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [_listOfLessons objectAtIndex:[indexPath row]];
